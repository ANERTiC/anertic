...
func Mount(mux *httpmux.Mux, am *arpc.Manager) {
	...
	a.Handle("POST /floor.assignDevice", am.Handler(floor.AssignDevice))
	a.Handle("POST /floor.unassignDevice", am.Handler(floor.UnassignDevice))
	...
	a.Handle("POST /charger.listConfigurations", am.Handler(charger.ListConfigurations))
	a.Handle("POST /charger.getConfiguration", am.Handler(charger.GetConfiguration))
	...
	a.Handle("POST /charger.listAuthTags", am.Handler(charger.ListAuthTags))
	a.Handle("POST /charger.addAuthTag", am.Handler(charger.AddAuthTag))
	a.Handle("POST /charger.removeAuthTag", am.Handler(charger.RemoveAuthTag))
	...
	a.Handle("POST /charger.remoteStop", am.Handler(charger.RemoteStop))
