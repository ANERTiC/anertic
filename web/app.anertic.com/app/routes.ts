  ...
  layout('layouts/console.tsx', [
    ...
    layout('layouts/site.tsx', [
      ...
      route('chargers/:chargerId', 'routes/charger-detail.tsx', [
        index('routes/charger-detail/analytics.tsx'),
        route('sessions', 'routes/charger-detail/sessions.tsx'),
        route('reservations', 'routes/charger-detail/reservations.tsx'),
        route('info', 'routes/charger-detail/info.tsx'),
        route('settings', 'routes/charger-detail/settings.tsx'),
        route('commands', 'routes/charger-detail/commands.tsx'),
        route('log', 'routes/charger-detail/log.tsx'),
      ]),
